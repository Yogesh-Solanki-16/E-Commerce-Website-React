...
const About = () => {
  return (
    <div
      id="about"
      className="min-h-screen bg-gray-100 py-10 px-4 sm:px-6 lg:px-20"
    >
      <div className="max-w-5xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-8">
        <h1 className="text-4xl font-bold  text-center">About Store</h1>

        <p className="text-gray-700 text-lg">
          Welcome to <span className="font-semibold text-red-600"> Store</span>,
        ...
        <div className="space-y-6">
          ...
          <p className="text-gray-700 text-base">
            At Store, our mission is to make innovative technology accessible to
